                ...
                <div class="">
                    ...
                    <div class="mb-3 w-full">
                        ...
                        <div class="inline-block relative w-full">
                            <select wire:model.defer="category" class="block appearance-none w-full bg-white border-r-lg border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
