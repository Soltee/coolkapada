<li
    ...
    class="mr-4 list-none"
    >
    <div class="flex items-center cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" 
            x-on:click="shopBag = !shopBag" 
            class="w-6 h-6 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
    ...
    <div 
        ...
        <div class="hidden md:block absolute left-0 top-0 bottom-0 md:w-1/2 flex flex-col bg-white h-screen bg-gray-900 opacity-70 py-6 px-4 sm:px-6">
        </div>
                ...
                <div>
                    ...
                    @if($total_qty > 0)
                        ...
                        <div class="border-t border-gray-200 mt-4">
                            ...
                            <div class="mt-6">
                              <a href="/checkout" class="flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-800 hover:bg-gray-700">Checkout</a>
                            </div>
                            <div class="mt-6 flex justify-center text-sm text-center text-gray-500">
                              <p>
                                or <a href="/bag" class="text-gray-600 font-medium hover:text-gray-500">Shopping Bag<span aria-hidden="true"> &rarr;</span></a>
                              </p>
                            </div>
                        </div>
