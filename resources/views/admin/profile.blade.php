   ...
   <div>
      <form action="{{ route('admin.update', $auth->id) }}" method="POST" accept-charset="utf-8">
         ...
         <div class="flex flex-wrap mb-6">
            ...
            <input id="email" type="email" class="border border-gray-500 px-3 py-3 rounded w-full @error('email') border-c-red @enderror" name="email" value="{{ $auth->email }}" required autocomplete="email">
