		    ...
		    <div class="flex justify-between items-center">
                ...
                <div 
                    ...
                    <button 
                        ...
                        type="submit" class=" px-3 py-2 w-40 text-center text-gray-900 hover:bg-gray-900 hover:text-white cursor-pointer rounded-lg border border-gray-300" >
                        Edit
                    </button> 
                        ...
                        <form method="POST" 
                            ...
                            <div class="flex flex-col shadow-2xl">
                                ...
                                <div class="flex justify-between items-center mb-5">
                                    ...
                                    <button type="submit" class=" px-3 py-2 w-40 text-center text-gray-900 hover:bg-gray-900 hover:text-white cursor-pointer rounded-lg border border-gray-600" >
                                        Edit
                                    </button>
