			...
			<div class="">
				...
				<form method="POST" action="/admin/products">
					...
					<div class="flex justify-between items-center">
						<h4 class="text-md mb-3 text-gray-700">{{ $product->name }}</h4>
						<button type="submit" class="px-3 py-3 bg-gray-900 hover:bg-gray-700 text-white  rounded-lg mb-12">Update</button>
