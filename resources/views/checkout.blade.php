							...
							<div class="mt-5 mb-2">
								<div class="flex flex-col">
									<label  class="custom_radio relative flex flex-col">
										<div class="radio_btn mr-2 px-5 py-3 rounded-lg  border border-blue-500 text-gray-900 cursor-pointer hover:border-blue-500 flex items-center @error('payment_method') border-red-500  @enderror">
											<input 
												class="mr-3" 
												type="radio"
												checked  
